...
global clientname, CONNECTED, liter_, cups_
CONNECTED = False
r=random.randrange(1, 10000000)
clientname="TAMI"+str(r)
DHT_topic = 'pr/home/Tami_4_Filter/5976397/sts'
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        formLayot.addRow("Liters", self.Liters)
...
class MainWindow(QMainWindow):
    ...
    def update_data(self):
        ...
        if liter_ > 0:
            liter_ = liter_ - random.randrange(8, 12)
        elif liter_ < 0:
            liter_ = 0
        ...
        # sending data status
        current_data = 'Liters: '+str(liter_)+' Cups: '+str(cups_)
        self.connectionDock.Liters.setText(str(liter_))
